<x-auth.auth-form>
    ...
    <div class="w-full max-w-sm">
        <form action="/login" method="POST" class="bg-white shadow-md rounded px-6 pt-5 pb-6">
            ...
            <input type="email" value="{{ old('email') }}" placeholder="Masukan email anda" name="email" class="mb-3 shadow w-full rounded-3xl border-[#EFF0F6] border-1 text-sm placeholder:text-sm py-2 px-2">
            ...
            <button type="submit" class="w-full text-base bg-[var(--color-primary)] text-white font-semibold py-2 rounded-3xl">LOG IN</button>
